...
import { Camera, Music, Book, Gamepad2, Plane, Coffee, Weight, Dumbbell } from "lucide-react";

const hobbiesData = [
  { name: "Photography", icon: Camera, description: "Capturing moments and exploring visual storytelling" },
  { name: "Travel", icon: Plane, description: "Exploring hiking trails and cuisines" },
  { name: "Gyming", icon: Dumbbell, description: "Lifting weights and staying fit" },
  { name: "Cricket", icon: Gamepad2, description: "Playing and watching cricket" },
];
